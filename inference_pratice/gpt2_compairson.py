...
print(np_gpt2.transformer_gpt2_inference(prompt, *np_gpt2.transformer_gpt2_model()))
...
gen_tokens = t_gpt2.generate(input_ids, do_sample=False, max_length=100)
...
np_gen_text = np_gpt2.generate(prompt, t_gpt2_tokenizer, max_token_len = 100)
np_end_time = time.time()

print(f'np_GPT2: \n{np_gen_text}')
print(f"np_GPT2 exicution time: {np_end_time - np_start_time}")

print(f'EDITED_TRANSFORMER_GPT2: \n{t_gen_text}')
